...
return (
    <div className="society-details">
        <div className="header">
            <img src={society.picture} alt={society.name} className="society-image" />
            <div className="header-info">
                <h1>{society.name}</h1>
                {society.tagline && <p className="tagline">{society.tagline}</p>}
            </div>
        </div>
        ...
        {society.background && (
            <section className="background">
                <h2>Background</h2>
                <img src={society.background} alt="Background" />
            </section>
        )}
    </div>
);
